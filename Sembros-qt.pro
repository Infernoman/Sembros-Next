...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wunused-but-set-variable -Wreturn-type -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector
...
isEmpty(SECP256K1_LIB_PATH) {
    ...
    SECP256K1_LIB_PATH=C:/dev/coindeps32/secp256knew/lib
}

isEmpty(SECP256K1_INCLUDE_PATH) {
    macx:SECP256K1_INCLUDE_PATH = /usr/local/include
    SECP256K1_INCLUDE_PATH=C:/dev/coindeps32/secp256knew/include
}
